...
**Mennotech** will license, configure, manage and monitor the Hornet Security M365 Backup Service on behalf of the **Client**.

The following features will be implemented for the **Client** by **Mennotech** as requested:
...
- **Mennotech** will meet regularly with the **Client** to discuss, plan and evaluate the **Client's** Information Technology needs and goals 
- **Mennotech** will provide advice to the **Client** for how to leverage Information Technology for strategic business goals 
- **Mennotech** will assist in developing an Information Technology roadmap outlining future technology investments and projects 

## Service Level Agreement 

**Mennotech** Support staff will provide the following level of technical support provided the request is received through the Helpdesk support channel as an email sent to **support@mennotech.ca**.  
...
The **Client** will pay **Mennotech** $85 CAD per user, per month. The number of users will be determined by the number of users licensed in the **Client's** Microsoft 365 Tenant.
